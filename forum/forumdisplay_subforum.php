...
<div class="bm zhanzhuai_hm_bm bmw box fl{if $_G['forum']['forumcolumns']} flg{/if}" style="margin-bottom: 20px;padding: 0;">
	<div class="bm_h cl" style=" height: 45px; line-height: 45px; border-bottom: 1px solid #f0f0f0; border-right: 0px solid #FFF; background: #fff; margin: 0; padding: 0; border-left: 0;">
	...
	<div id="subforum_{$_G[forum][fid]}" class="bm_c" style="$collapse[subforum]    background: #fff;">
