...
<div id="postlist" class="zhanzhuai_viewthread_lz pl">


<!--{eval $authorid = $_G[forum_thread][authorid];}-->
            ...
            <div class="top-title">
                ...
                <div class="zhanzhuai_v_author cl">
				    <div class="user-pic z">
				         <a href="home.php?mod=space&uid=$_G[forum_thread][authorid]" target="_blank" title="$_G[forum_thread][author]">
					...
					<div class="user-info z">
                        <div class="title-bottom cl">
				             <div class="z">
							     <span><a href="home.php?mod=space&uid=$_G[forum_thread][authorid]" target="_blank" title="$_G[forum_thread][author]">$_G[forum_thread][author]</a></span>
                                 <span><!--{echo dgmdate($_G[forum_thread][dateline], 'u', '9999', getglobal('setting/dateformat'))}--></span>
							 </div>
							 <div class="y">
                                 <span class="view"><i class="zhanzhuai-icons"></i>$_G[forum_thread][views]</span>
                                 <span class="hits"><i class="zhanzhuai-icons"></i>$_G[forum_thread][recommend_add]</span>
                                 <span class="comment"><i class="zhanzhuai-icons"></i>$_G[forum_thread][allreplies]</span>
                            ...
                            <span>
					            <a href="forum.php?mod=forumdisplay&fid=$_G[fid]">$_G['forum'][name]</a>
	                               ...
	                               <!--{if !$rushreply}-->
				                       ...
				                       <!--{else}-->
						                   &nbsp;/&nbsp;<a href="forum.php?mod=viewthread&tid=$_G[tid]&extra=$_GET[extra]&ordertype=2"  class="show">{lang post_ascview}</a>
				                       <!--{/if}-->
			                       <!--{/if}-->
					        </span>
			...
			<tr>
				...
				<!--{/if}-->
					<!--{if $rushresult[rewardfloor]}-->
						...
						<!--{if !$_GET['checkrush']}-->
								<a href="forum.php?mod=viewthread&tid=$post[tid]&checkrush=1" rel="nofollow" class="y pn xi2" style="color: #fff !important;"><span>{lang rushreply_view}</span></a>
						<!--{/if}-->
						</span>
					<!--{/if}-->
...
<div class="zhanzhuai-vad cl">
    <!--[diy=zhanzhuai-vad]--><div id="zhanzhuai-vad" class="area"></div><!--[/diy]-->
</div>
...
<!--{if $_G[forum_thread][allreplies] > 0}-->
    <div class="pgs cl" style="margin: 20px 0 5px;">$multipage</div>
<!--{/if}-->
