			...
			<div id="vfastpost" class="fullvfastpost">				
				...
				<table cellspacing="0" cellpadding="0" id="vfastposttb">
					<tr>
						...
						<td id="vf_r"></td>						
						<td id="vf_b">
							<button type="submit" class="pn pnc" name="replysubmit" id="vreplysubmit" value="true" style="">{lang post_newreply}</button>								
						</td>						
					</tr>
				</table>				
			</div>
...
<table class="ratl">
						<tr>
							<th class="xw1 t" width="120"><a href="forum.php?mod=misc&action=viewratings&tid=$_G[tid]&pid=$post[pid]" onclick="showWindow('viewratings', this.href)" title="{lang rate_view}"> {lang number_of_participants} <span class="xi1"><!--{echo count($postlist[$post[pid]][totalrate]);}--></span></a></th>
