...
<head>
    ...
    <!--{csstemplate}-->
    <script type="text/javascript" src="$_G['style']['styleimgdir']/js/jquery-1.12.1.min.js"></script>
    <script type="text/javascript" src="$_G['style']['styleimgdir']/js/jquery.ajax-ias.min.js"></script>
    ...
    <!--{eval $todayposts = DB::result_first("SELECT sum(todayposts) FROM ".DB::table('forum_forum')." WHERE status=1"); $yesterdayposts = DB::result_first("SELECT sum(yesterdayposts) FROM ".DB::table('forum_forum')." WHERE status=1"); $posts = DB::result_first("SELECT sum(posts) FROM ".DB::table('forum_forum')." WHERE status=1");}-->